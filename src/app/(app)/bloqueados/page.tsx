    ...
    <div style={{ paddingBottom: 40 }}>
      ...
      <div className="animate-fade-up" style={{ marginBottom: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 6 }}>
          ...
          <h1 className="text-title" style={{ fontSize: 22 }}>Clientes Bloqueados</h1>
        </div>
      ...
      <div className="animate-fade-up animate-delay-100">
        {isLoading ? (
          ...
          <div className="card" style={{ padding: '60px 20px', textAlign: 'center' }}>
            ...
            <p className="text-title" style={{ fontSize: 16, marginBottom: 4 }}>Nenhum cliente bloqueado</p>
            <p style={{ fontSize: 13, color: 'var(--text-muted)' }}>Nenhum registro encontrado no período.</p>
          </div>
        ) : (
          <>
            {/* Summary Stats */}
                            ...
                            {fin ? (
                              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                                  ...
                                  <span style={{ fontSize: 13, fontFamily: 'var(--font-mono)', fontWeight: 700, color: '#ef4444' }}>{formatMoeda(fin.valorEmAberto)}</span>
                                </div>
                                {fin.diasAtraso > 0 && (
                                  <span className={fin.diasAtraso > 90 ? 'badge badge-danger' : fin.diasAtraso > 30 ? 'badge badge-warn' : 'badge badge-muted'}
